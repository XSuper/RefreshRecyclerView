...
public class ZrcRefreshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setFooterEdge(new ZrcFooterEdge(this));
        recyclerView.setHeaderEdge(new ZrcHeaderEdge(this));
